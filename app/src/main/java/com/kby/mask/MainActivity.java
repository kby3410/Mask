        ...
        infoWindow.setAdapter(new InfoWindow.DefaultViewAdapter(this) {
            ...
            protected View getContentView(@NonNull InfoWindow infoWindow) {
                ...
                if("plenty".equalsIgnoreCase(store.remain_stat)){
                    ...
                    ((TextView) view.findViewById(R.id.stock)).setText("1개 미만");
                ...
                ((TextView) view.findViewById(R.id.time)).setText("입고시간 : " + store.stock_at);
                return view;
            }
        });


        LatLng mapCenter = naverMap.getCameraPosition().target;     //지도상의 위도,경도 얻어옴
